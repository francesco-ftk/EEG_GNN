...
% COSTRUISCO MATRICE DI INPUT 18x3000x1 per ogni finestra (60) per ogni banda

% n=18; % elettrodi
% m=3000; % campioni per finestra
% N=60; % finestre immagini

EEG_subject_norm = normalize(EEG_delta_subject_26); % Normalizza per colonne la matrice
trueGround = features_images_26(4,1);
answer = features_images_26(5,1);
eval(['GCmatrix_26_1_' num2str(trueGround) '_' num2str(answer) '=1;']);
save("PythonDatas/GC/GCmatrix_delta_26.mat", sprintf('GCmatrix_26_1_%d_%d',features_images_26(4,1),features_images_26(5,1)));
InputGCNN_26_1 = 1;
save("PythonDatas/Input/Input_delta_26.mat", 'InputGCNN_26_1'); 
for i=1:60
    ...
    save("PythonDatas/GC/GCmatrix_delta_26.mat", sprintf('GCmatrix_26_%d_%d_%d',i,features_images_26(4,i),features_images_26(5,i)), '-append');
    eval(['InputGCNN_26_' num2str(i) '=M;']);
    save("PythonDatas/Input/Input_delta_26.mat", sprintf('InputGCNN_26_%d',i), '-append'); 
end
